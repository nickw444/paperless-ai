...
from main import AnalyzeOptions, _select_documents_for_analysis, _validate_analyze_options
...
def test_select_documents_excludes_tracked_tags_and_applies_limit():
    ...
    documents = _select_documents_for_analysis(engine, _options(limit=2))
...
def test_select_documents_fetches_specific_document_without_inbox_filtering():
    ...
    documents = _select_documents_for_analysis(engine, _options(doc_id=42))
...
def test_select_documents_reprocess_stale_keeps_unparsed_and_stale_documents():
    ...
    documents = _select_documents_for_analysis(engine, _options(reprocess_stale=True))
